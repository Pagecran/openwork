...
export default {
  ...
  "settings.starter_bootstrap_desc": "Control whether OpenWork auto-creates the Welcome workspace and starter onboarding content for plain local workspaces.",
  "settings.starter_bootstrap_title": "Starter bootstrap",
  "settings.starter_bootstrap_toggle": "Automatic starter content",
  "settings.starter_bootstrap_toggle_desc": "When enabled, OpenWork can create the Welcome workspace, starter sessions, and starter suggestions for new default workspaces.",
