...
test("static provisioner in-process reservations prevent concurrent duplicate assignment", async () => {
  ...
  provisionerModule.releaseStaticWorkerUrl("worker_static_concurrent_a_123", staticWorkerUrl)
  provisionerModule.releaseStaticWorkerUrl("worker_static_concurrent_b_123", staticWorkerUrl)
})
